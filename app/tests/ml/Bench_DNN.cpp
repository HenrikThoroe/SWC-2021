...
TEST_CASE("Bench DNN", "[benchmark][ml][net]") {
    ...
    DNN net_400x44x22x1 = DNN({ 400, 44, 22, 1 }, { ActivationFunction::Type::LEAKY_RELU, ActivationFunction::Type::LEAKY_RELU, ActivationFunction::Type::SIGMOID }, true);
    ...
    BENCHMARK("[400, 44, 22, 1]") {
        return net_400x44x22x1.predict(input_400);
    };
